...
house.add(roof)
// gui.add(roof, 'rotation').min(0).max(5).step(.1)
...
for (let i = 0; i < 50; i++) {
   ...
   grave.position.set(x, .4, z)

   grave.rotation.y = (Math.random() - .5) * .2
...
const PointLightCameraHelper = new THREE.PointLightHelper(doorLight, 1)
PointLightCameraHelper.visible = false
scene.add(PointLightCameraHelper)

// Ghosts
const ghost1 = new THREE.PointLight('#ff00ff', 7, 3)
const ghost2 = new THREE.PointLight('#4ce3e0', 7, 3)
const ghost3 = new THREE.PointLight('red', 7, 3)
